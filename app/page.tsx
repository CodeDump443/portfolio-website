    ...
    <main className="flex items-center relative h-screen overflow-hidden">
      ...
      <div className="flex flex-col gap-3 z-[10] px-4 md:pl-40 pt-20 text-center md:text-left w-full max-w-screen-md">
        ...
        <p className="text-[16px] sm:text-[18px] md:text-[19px] text-gray-200 md:text-gray-400 mb-10 md:pb-2 mx-auto md:mx-0 max-w-[400px]">
          Меня зовут Ралия, это сайт с использованием React и Next.js на версии{" "}
          <span className="font-bold" style={{ color: "#BFC4CC" }}>13.5.4</span>. Я тщательно взвесила функциональность каждой версии и остановилась на той, что наиболее оптимально решает мои текущие задачи. Меня вдохновляет идея создавать интерактивный опыт, объединяющий технологии, творчество и пользовательское восприятие.{" "}
          <span className="font-bold" style={{ color: "#BFC4CC" }}>Мои социальные сети находятся сверху справа:</span>
        </p>
      </div>
    </main>
  );
